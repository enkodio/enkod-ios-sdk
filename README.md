...
6. Отключите Sandbox в настройках Xcode - для этого перейдите в настройки таргета приложения, далее перейдите в раздел Build Settings. Ниже выберите настройки отображаемых пунктов раздела - All и Combined. В поисковой строке (правый верхний угол окна среды разработки) укажите Sandbox, после чего будет отображена настройка User Script Sandboxing - установите значение для данного пункта - "No"
