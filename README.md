...
Данный метод позволяет отправлять кастомные события в систему Enkod. Используйте его, когда вам необходимо отслеживать специфические действия пользователей, которые не покрываются стандартными событиями трекинга.
...
```swift
// Отправка кастомного события "registration_completed"
